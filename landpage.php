...
<body>
    ...
    <div class="navbar  navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <h1 class="font-weight-bold">SAAMPT </h1>
    ...
    <main class="container_1">
        <div class="row" id="principal">
            <div class="col-md-6 text-center ">
                <img src="imagenes/mujercarro.jpg" alt="" id="imagen-principal">
            </div>
        ...
        <div class="row flex-row-reverse" id="nosotros">
            <div class="col-md-6 text-center ">
                <img src="imagenes/rentacarro1.jpg" alt="">
            </div>
        ...
        <div class="row" id="Seguridad" >
            <div class="col-md-6 text-center ">
                <img src="imagenes/rentacarro2.jpg" alt="">
            </div>
        ...
        <div class="row flex-row-reverse" id="contacto">
            <div class="col-md-6 text-center ">
                <img src="imagenes/sevicio1.jpg" alt="" id="servicio">
            </div>
